...
public class LootTableReporter {
    ...
    private LootTableReporter(ErrorReporter errorReporter, LootContextType contextType, Optional<RegistryEntryLookup.RegistryLookup> dataLookup, Set<RegistryKey<?>> referenceStack) {
