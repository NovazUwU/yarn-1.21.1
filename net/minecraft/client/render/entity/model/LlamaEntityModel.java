...
extends EntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, int color) {
        if (this.child) {
            ...
            matrices.translate(0.0f, 2.0625f, 0.0f);
            ImmutableList.of(this.rightHindLeg, this.leftHindLeg, this.rightFrontLeg, this.leftFrontLeg, this.rightChest, this.leftChest).forEach(arg3 -> arg3.render(matrices, vertices, light, overlay, color));
            matrices.pop();
        } else {
            ImmutableList.of(this.head, this.body, this.rightHindLeg, this.leftHindLeg, this.rightFrontLeg, this.leftFrontLeg, this.rightChest, this.leftChest).forEach(arg3 -> arg3.render(matrices, vertices, light, overlay, color));
        }
    }
}
