...
Vibrations {
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        Vibrations.ListenerData.CODEC.encodeStart(lv, this.vibrationListenerData).resultOrPartial(string -> LOGGER.error("Failed to encode vibration listener for Allay: '{}'", string)).ifPresent(arg2 -> nbt.put("listener", (NbtElement)arg2));
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("listener", NbtElement.COMPOUND_TYPE)) {
            Vibrations.ListenerData.CODEC.parse(lv, nbt.getCompound("listener")).resultOrPartial(string -> LOGGER.error("Failed to parse vibration listener for Allay: '{}'", string)).ifPresent(arg -> {
