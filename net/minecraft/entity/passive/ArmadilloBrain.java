...
public class ArmadilloBrain {
    ...
    private static void addCoreActivities(Brain<ArmadilloEntity> brain) {
        brain.setTaskList(Activity.CORE, 0, ImmutableList.of(new StayAboveWaterTask(0.8f), new UnrollAndFleeTask(2.0f), new LookAroundTask(45, 90), new MoveToTargetTask(){
