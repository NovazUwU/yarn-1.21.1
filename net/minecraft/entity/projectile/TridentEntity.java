...
extends PersistentProjectileEntity {
    ...
    protected void onBlockHitEnchantmentEffects(ServerWorld world, BlockHitResult blockHitResult, ItemStack weaponStack) {
        ...
        EnchantmentHelper.onHitBlock(world, weaponStack, entity instanceof LivingEntity ? (lv2 = (LivingEntity)entity) : null, this, null, lv, world.getBlockState(blockHitResult.getBlockPos()), item -> this.kill());
    }
