    ...
    public void tick() {
        block20: {
            ...
            for (LivingEntity lv3 : list2) {
                ...
                double m;
                double o;
                if (this.affectedEntities.containsKey(lv3) || !lv3.isAffectedBySplashPotions()) continue;
                if (list.stream().noneMatch(lv3::canHaveStatusEffect) || !((o = (m = lv3.getX() - this.getX()) * m + (n = lv3.getZ() - this.getZ()) * n) <= (double)(f * f))) continue;
